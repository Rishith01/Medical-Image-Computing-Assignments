...
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.8\textwidth]{dict_objective_placeholder.png}
...
% \begin{figure}[H]
% \centering
% \includegraphics[width=\textwidth]{dict_atoms_placeholder.png}
% \caption{Initial dictionary atoms (top row) and learned dictionary atoms (bottom row) for different values of $p$.}
% \end{figure}
...
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.8\textwidth]{coeff_hist_placeholder.png}
...
A noisy version of the chest CT image was generated by adding i.i.d. Gaussian noise with standard deviation equal to $10\%$ of the image intensity range.
...
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.8\textwidth]{denoise_objective_placeholder.png}
...
% \begin{figure}[H]
% \centering
% \includegraphics[width=\textwidth]{ct_denoising_placeholder.png}
